...
public class OpenGlUtils {
	...
	public static final int beautyLevel = 5;
	...
	public static int loadTextureByStr(final Context context, String resId){
		final int[] textureHandle = new int[1];
		...
		if (textureHandle[0] != 0){
			...
			final Bitmap bitmap = getImageFromAssetsFile(context,resId);
