package ffmpeg.egg.io.mediacodectest.record.glutils;
/*
...
public final class RenderHandler implements Runnable {
	...
	public static final RenderHandler createHandler(int width, int height, Context context, final String name) {
		mContext = context;
		mWidth = width;
		mHeight = height;
	...
	public final void setEglContext(TranscodingResources recources,final EGLContext shared_context, final int tex_id, final Object surface, final boolean isRecordable) {
