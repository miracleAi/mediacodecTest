...
public class ImageTransformationMatrix {
    ...
    public float[] adjustForTranscoderTransformation() {
        Matrix.setRotateM(this.mTransformation, 0, 180, 1.0f, 0.0f, 0.0f);
        Matrix.translateM(this.mTransformation, 0, 0.0f, -1.0f, 0.0f);
        return this.mTransformation;
    }

    public float[] flipHorizontal() {
        Matrix.setRotateM(this.mTransformation, 0, 180, 0.0f, 0.0f, 1.0f);
        Matrix.translateM(this.mTransformation, 0, -1.0f, -1.0f, 0.0f);
        return this.mTransformation;
    }

    public float[] rotate180Degrees() {
        Matrix.setRotateM(this.mTransformation, 0, 180, 0.0f, 1.0f, 0.0f);
    ...
    public float[] rotateRight() {
        ...
        Matrix.translateM(this.mTransformation, 0, 0.0f, -1, 0.0f);
        return this.mTransformation;
    }

    public float[] rotateLeft() {
        Matrix.rotateM(adjustForTranscoderTransformation(), 0, 270, 0.0f, 0.0f, 1.0f);
        Matrix.translateM(this.mTransformation, 0, -1, 0.0f, 0.0f);
        return this.mTransformation;
    }
}
