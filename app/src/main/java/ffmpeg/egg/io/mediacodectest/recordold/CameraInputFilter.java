package ffmpeg.egg.io.mediacodectest.recordold;
...
/**
 * Created by zhulinping on 16/12/20.
 */
...
public class CameraInputFilter extends GPUImageFilter {
    ...
    private int mBeautyLevel = OpenGlUtils.beautyLevel;
    ...
    public void onBeautyChange(boolean isBeauty){
        if(!isBeauty){
            ...
            mBeautyLevel = OpenGlUtils.beautyLevel;
        }
        setBeautyLevel(mBeautyLevel);
    }
}