package ffmpeg.egg.io.mediacodectest.record.encoder;
/*
...
public class MediaVideoEncoder extends MediaEncoder {
	...
	public MediaVideoEncoder(Context context,final MediaMuxerWrapper muxer, final MediaEncoderListener listener, final int width, final int height) {
	...
	public void setEglContext(TranscodingResources resources, final EGLContext shared_context, final int tex_id) {
		mRenderHandler.setEglContext(resources,shared_context, tex_id, mSurface, true);
	}
